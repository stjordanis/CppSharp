...
// which is to stop exporting the templates as only definitions are exported
// this is basically an ms bug so simply ignore the warning
// http://www.unknownroad.com/rtfm/VisualStudio/warningC4251.html for more details
template <typename T>
